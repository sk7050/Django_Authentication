...
class UserCreationForm(forms.ModelForm):
    ...
    password1 = forms.CharField(label='', widget=forms.PasswordInput(attrs={'class': 'form-control','name':"password1",'placeholder':"Password"}))
    password2 = forms.CharField(label='', widget=forms.PasswordInput(attrs={'class': 'form-control','name':"password2",'placeholder':"Conforme Password"}))
